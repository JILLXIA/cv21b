...
test_images=json.load(open("dataHomework/val/val.json",'r'))
category_mapping=[]
...
if __name__ == '__main__':
    ...
    pred_images = json.load(open('newEpch14_val_v7.json'))
    gt_images = json.load(open('dataHomework/val/val.json'))
